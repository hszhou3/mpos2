...
Due to space limit, many technical discussions and illustrations about the definitions have be moved to Appendix~\ref{app:DG-DQ-DCP}. 
...
See Figure~\ref{fig:dg} in Appendix~\ref{app:DG} for illustration of the idea. 
Technical discussions can also be found in Appendix~\ref{app:DG}. 
...
Please also see Figure~\ref{fig:dq} in Appendix~\ref{app:DQ} for illustration of the idea. 
...
Please also see Figure~\ref{fig:dcp} in Appendix~\ref{app:DCP} for illustration of the idea. 
...
See Figure~\ref{fig:persistence} in Appendix~\ref{app:persistence} for illustration of the idea. 
...
See Figure~\ref{fig:liveness} in Appendix~\ref{app:liveness} for illustration of the idea. 
Extended discussions can be found in Appendix~\ref{app:liveness}. % for more technical discussions about this definition. 
...
%\newpage
% --- THIS PART IS NEW: compact necessity statement ---
\begin{remark}[Necessity of TB in one picture]
...
\paragraph{Why TB.}
TB caps the number of concurrent honest tips, preventing indefinite fragmentation.
Together with DG and DQ, this ensures merge pressure and stabilizes the anchored fork choice.
(Extended discussions can be found in Appendix~\ref{app:TB}.)
