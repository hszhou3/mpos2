...
\paragraph{Where are the details?} Formal proofs, extended remarks, and scenarios appear in Appendix~\ref{app:ideal-security}. We keep only essential statements here.
...
\end{theorem}
\noindent\emph{Details moved to Appendix~\ref{app:ideal-security}.}
