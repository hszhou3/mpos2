...
\begin{enumerate}
  ...
  \item \textbf{Block creation (Alg.~\ref{alg:ideal-create}).} If eligible, $P$ constructs block \\
  $b_s=\langle \id,\val{=}P,\slot{=}s,\txs,\refs{=}A_s\rangle$ and broadcasts $b_s$.
...
Due to space limit, additional notions and definitions can be found in Appendix~\ref{app:ideal-notion}. 
...
Due to space limits, additional discussions can be found in Appendix~\ref{app:ideal-protocol}. 
