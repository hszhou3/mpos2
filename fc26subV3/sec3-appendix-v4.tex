...
\section{Supplemental Materials for Section~\ref{sec:ideal}}
\label{app:ideal}
...
\subsection{Additional Definitions Used in Section~\ref{sec:ideal-notion}}\label{app:ideal-notion}
...
\subsection{Additional Discussions for Section~\ref{sec:ideal-protocol}}
\label{app:ideal-protocol}
...
\subsection{Security of the Idealized Protocol: Details}
\label{app:ideal-security}
...
We now show the consensus properties can be achieved as stated in Theorem~\ref{thm:base-consensus-summary}. 
...
We now show ledger properties can be achieved as stated in Theorem~\ref{thm:ideal-ledger-summary}. 
