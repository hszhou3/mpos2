...
\begin{figure}[htbp!]
\subfloat[\ProjBase, $\alpha=0.30$]{\includegraphics[width=\textwidth/4]{figs/adv-30.png}}
\subfloat[Praos, $\alpha=0.30$]{\includegraphics[height=21mm, keepaspectratio]{figs/reorg-praos-f0.05-as30-d2-1M-OK}}
\subfloat[\ProjBase, $\alpha=0.40$]{\includegraphics[width=\textwidth/4]{figs/adv-40.png}}
\subfloat[Praos, $\alpha=0.40$]{\includegraphics[height=21mm, keepaspectratio]{figs/reorg-praos-f0.05-as40-d2-1M-OK}}\\
\subfloat[\ProjBase, $\alpha=0.45$]{\includegraphics[width=\textwidth/4]{figs/adv-45.png}}
\subfloat[Praos, $\alpha=0.45$]{\includegraphics[height=21mm, keepaspectratio]{figs/reorg-praos-f0.05-as45-d2-1M-OK}}
\subfloat[\ProjBase, $\alpha=0.49$]{\includegraphics[width=\textwidth/4]{figs/adv-49.png}}
\subfloat[Praos, $\alpha=0.49$]{\includegraphics[height=21mm, keepaspectratio]{figs/reorg-praos-f0.05-as49-d2-1M-OK}}\\
\subfloat[\ProjBase $\alpha=0.51$]{\includegraphics[width=\textwidth/4]{figs/adv-51.png}}
\subfloat[Praos, $\alpha=0.51$]{\includegraphics[height=21mm, keepaspectratio]{figs/reorg-praos-f0.05-as51-d2-1M-OK}}
\subfloat[\ProjBase, $\alpha=0.60$]{\includegraphics[width=\textwidth/4]{figs/adv-60.png}}
\subfloat[Praos, $\alpha=0.60$]{\includegraphics[height=21mm, keepaspectratio]{figs/reorg-praos-f0.05-as60-d2-1M-OK}}\\
...
\begin{figure}[htbp!]
\subfloat[$f=0.05$ and $\Delta=2$s]{\includegraphics[width=\textwidth/4]{figs/reorg-C2-f0.05-no_blend-d2s-w30-100k-mr1069-sa0.png}}
\subfloat[$f=0.1$ and $\Delta=2$s]{\includegraphics[width=\textwidth/4]{figs/reorg-C2-f0.1-no_blend-d2s-w30-100k-mr998-sa0}}
\subfloat[$f=0.2$ and $\Delta=2$s]{\includegraphics[width=\textwidth/4]{figs/reorg-C2-f0.2-no_blend-d2s-w30-100k-mr377-sa0}}
\subfloat[Praos and $\Delta=2$s]{\includegraphics[height=21mm, keepaspectratio]{figs/reorg-praos-f0.05-as30-d2-1M-OK}}\\
\subfloat[$f=0.05$ and $\Delta=5$s]{\includegraphics[width=\textwidth/4]{figs/reorg-C2-f0.05-no_blend-d5s-w30-100k-mr1145-sa0.png}}
\subfloat[$f=0.1$ and $\Delta=5$s]{\includegraphics[width=\textwidth/4]{figs/reorg-C2-f0.1-no_blend-d5s-w30-100k-mr860-sa0}}
\subfloat[$f=0.2$ and $\Delta=5$s]{\includegraphics[width=\textwidth/4]{figs/reorg-C2-f0.2-no_blend-d5s-w30-100k-mr324-sa0}}
\subfloat[Praos and $\Delta=5$s]{\includegraphics[height=21mm, keepaspectratio]{figs/reorg-praos-f0.05-as30-d5-1M-OK}}\\
\subfloat[$f=0.05$ and $\Delta=8$s]{\includegraphics[width=\textwidth/4]{figs/reorg-C2-f0.05-no_blend-d8s-w30-100k-mr1379-sa0.png}}
\subfloat[$f=0.1$ and $\Delta=8$s]{\includegraphics[width=\textwidth/4]{figs/reorg-C2-f0.1-no_blend-d8s-w30-100k-mr937-sa0}}
\subfloat[$f=0.2$ and $\Delta=8$s]{\includegraphics[width=\textwidth/4]{figs/reorg-C2-f0.2-no_blend-d8s-w30-100k-mr411-sa0}}
\subfloat[Praos and $\Delta=8$s]{\includegraphics[height=21mm, keepaspectratio]{figs/reorg-praos-f0.05-as30-d8-1M-OK}}\\
\subfloat[$f=0.05$ and $\Delta=10$s]{\includegraphics[width=\textwidth/4]{figs/reorg-C2-f0.05-no_blend-d10s-w30-100k-mr1282-sa0.png}}
\subfloat[$f=0.1$ and $\Delta=10$s]{\includegraphics[width=\textwidth/4]{figs/reorg-C2-f0.1-no_blend-d10s-w30-100k-mr1001-sa0}}
\subfloat[$f=0.2$ and $\Delta=10$s]{\includegraphics[width=\textwidth/4]{figs/reorg-C2-f0.2-no_blend-d10s-w30-100k-mr329-sa0}}
\subfloat[Praos and $\Delta=10$s]{\includegraphics[height=21mm, keepaspectratio]{figs/reorg-praos-f0.05-as30-d10-1M-OK}}\\
\subfloat[$f=0.05$ and $\Delta=12$s]{\includegraphics[width=\textwidth/4]{figs/reorg-C2-f0.05-no_blend-d12s-w30-100k-mr1436-sa0.png}}
\subfloat[$f=0.1$ and $\Delta=12$s]{\includegraphics[width=\textwidth/4]{figs/reorg-C2-f0.1-no_blend-d12s-w30-100k-mr1056-sa0}}
\subfloat[$f=0.2$ and $\Delta=12$s]{\includegraphics[width=\textwidth/4]{figs/reorg-C2-f0.2-no_blend-d12s-w30-100k-mr378-sa0}}
\subfloat[Praos and $\Delta=12$s]{\includegraphics[height=21mm, keepaspectratio]{figs/reorg-praos-f0.05-as30-d12-1M-OK}}\\
\subfloat[$f=0.05$ and $\Delta=15$s]{\includegraphics[width=\textwidth/4]{figs/reorg-C2-f0.05-no_blend-d15s-w30-100k-mr1912-sa0.png}}
\subfloat[$f=0.1$ and $\Delta=15$s]{\includegraphics[width=\textwidth/4]{figs/reorg-C2-f0.1-no_blend-d15s-w30-100k-mr1222-sa0}}
\subfloat[$f=0.2$ and $\Delta=15$s]{\includegraphics[width=\textwidth/4]{figs/reorg-C2-f0.2-no_blend-d15s-w30-100k-mr383-sa0}}
\subfloat[Praos and $\Delta=15$s]{\includegraphics[height=21mm, keepaspectratio]{figs/reorg-praos-f0.05-as30-d15-1M-OK}}\\
...
%    ylabel={Max reorg depth},
%    xmin=2, xmax=20,
%    ymin=0, ymax=3500,
%    xtick={2,5,8,10,12,15,20},
...
%    ]
%    coordinates {
%    (2,1069)(5,1145)(8,1379)(10,1282)(12,1436)(15,1912)(20,3323)
%    };
...
%    ]
%    coordinates {
%    (2,998)(5,860)(8,937)(10,1001)(12,1056)(15,1222)(20,1340)
%    };
...
%    ]
%    coordinates {
%    (2,377)(5,324)(8,411)(10,329)(12,378)(15,383)(20,443)
%    };
...
\end{axis}
\end{tikzpicture}
\caption{Relation between mean broadcast delay on the reorg depth of \ProjBase with 30\% adversarial stake, window size of 30 slots and $f=0.25$. When the mean broadcast delay exceeds the window size, the reorg depth commences to increase exponentially. Consequently, $w \geq \Delta$ ensures that the reorg depth remains low.} %Successful majority chain with minority stake become probable when the mean broadcast delay approaches double the window size. Consequently, $w \geq \Delta$ ensures that the reorg depth remains low, thereby reducing the likelihood of including successful majority chain with minority stake. Conversely, $2\Delta < w < \Delta$ results in a higher reorg depth, while $w \leq 2\Delta$ significantly increases the probability of successful majority chain with minority stake inclusion.
