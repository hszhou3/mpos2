...
\title{
Cryptareon: Scalable and Resilient Multi-Proposer Consensus\mnote{Maybe "Cryptareon: Latency-Friendly Resilient Multi-Proposer Consensus?"}\footnote{We refer interested readers to Álvaro Castro-Castilla’s ``New Cryptarchia,'' available at \url{https://www.notion.so/nomos-tech/New-Cryptarchia-202261aa09df8026b31ad5e09c1a3fbb}.\mnote{This footnote should be removed}}
\\
...
\end{equation*}
\end{definition} \mnote{I'm wondering if this indeed should be linear... If we assume leaderless case then we can have multiple honest blocks attached to one or more tip. Or maybe this should be interpreted as a single path on a DAG?}
