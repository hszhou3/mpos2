...
\usepackage{xspace,xcolor,amsmath,mathtools,amsfonts}
\usepackage{amssymb}
...
\title{\Proj: Low-Latency Multi‑Proposer Consensus
...
%Section 3: Protocol-Ideal  
\newpage
\input{sec3-v4}
%\input{sec3-v3}

%Section 4: Protocol-Base  
\input{sec4-v4}
%\input{sec4-v3}

%Section 5: Experiment and Evaluation 
\input{sec5-v4}
%\input{sec5-v3}
...
%\input{app-sec2}
\input{app-sec4} %\input{appendix1}
